...
// #include "EmgChannel.h"  // TODO: missing file
#include <stdint.h>
...
public:
  ...
  // TODO: uncomment when EmgChannel.h is available
  // void begin(const EmgArray& emg);
  void begin(const int& emg);  // placeholder
...
private:
  ...
  const int*    emg_ = nullptr;  // placeholder
